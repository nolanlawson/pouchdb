...
var ADAPTER_VERSION_KEY = '_local_adapter_version';
  ...
  function initstore(store_name, encoding) {
    ...
    function setup_store(err, ldb) {
      ...
      function setAdapterVersion() {
        stores[BY_SEQ_STORE].put(ADAPTER_VERSION_KEY, ADAPTER_VERSION, function (err) {
          finish();
        });
      }
      ...
      function runMigrations() {
        ...
        stores[BY_SEQ_STORE].get(ADAPTER_VERSION_KEY, function (err, value) {
