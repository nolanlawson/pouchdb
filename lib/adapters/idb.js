...
function IdbPouch(opts, callback) {
    ...
    function writeDoc(docInfo, callback) {
      ...
      function finish() {
        ...
        dataReq.onsuccess = function (e) {
          ...
          var metadata = utils.extend(true, {}, docInfo.metadata);
          metadata.deleted = utils.isDeleted(docInfo.metadata) ? "1" : "0";
  ...
  function allDocsNormalQuery(totalRows, opts, callback) {
    ...
    if (descending && start && end) {
      ...
      // start is greater than the end in descending mode.  Best bet
    ...
    try {
      ...
      if (e.name === "DataError" && e.code === 0) {
        // data error, start is greater than end
